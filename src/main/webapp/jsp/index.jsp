...
<body>
	...
	<c:if test="${ null ne sessionScope.userName }">
		<div>
			<span>${userName }님 </span> <span> <input type="button"
				id="btnLogout" value="로그아웃">
			</span>
		</div>
		<div>
			<ul>
	...
	<div id="popup_layer" style="display: none">
		<div class="popup_box">
			...
			<div class="popup_btn">
				<!--하루동안 보지않기-->
				<a id="chk_today" href="javascript:closeToday();" class="close_day">Do
					not open for a day</a>
				<!--7일간 보지않기-->
